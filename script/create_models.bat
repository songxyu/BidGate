...
start rails generate model GoodsPropValue category:references goods_prop:references  prop_value:string
...
start rails generate model GoodsExt goods_prop:references prop_value:string order_goods:references
